 ...
 */
export function buildReportCard(ctx) {
 ...
 */
export function buildComprehensivePrompt(ctx) {
 ...
 */
export function buildPersonalityPrompt(ctx) {
    const report = buildReportCard(ctx);
    const s = ctx.strength;
    const st = ctx.structure;
    const c = ctx.climate;
 ...
 */
export function buildRelationshipPrompt(ctx) {
    const report = buildReportCard(ctx);
    const s = ctx.strength;
    const st = ctx.structure;
 ...
 */
export function buildStrategyPrompt(ctx, question) {
    const report = buildReportCard(ctx);
 ...
 */
export function buildYearlyFortunePrompt(ctx, year) {
    const report = buildReportCard(ctx);
