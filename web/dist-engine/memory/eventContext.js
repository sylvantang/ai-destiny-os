 ...
 */
export function computeEventContext(birth, eventDate) {
    ...
    // 年龄
    const birthEpoch = Date.UTC(birth.year, birth.month - 1, birth.day, birth.hour, birth.minute) - 8 * 3600 * 1000;
 ...
 */
export function addEventWithContext(store, birth, event) {
