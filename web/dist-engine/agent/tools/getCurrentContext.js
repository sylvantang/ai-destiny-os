...
// ============================================================
export const getCurrentContextTool = {
...
function getDimensionScore(dims, key) {
    const map = { '事业': dims.career, '财富': dims.wealth, '感情': dims.relationship, '健康': dims.health };
    return map[key] ?? 0;
}
//# sourceMappingURL=getCurrentContext.js.map